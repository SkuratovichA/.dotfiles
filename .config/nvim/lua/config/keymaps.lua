...
map("n", "<C-w><kLeft>", "<C-w><kLeft>", { desc = "Go to left window", remap = true })
map("n", "<C-w><kDown>", "<C-w><kDown>", { desc = "Go to lower window", remap = true })
map("n", "<C-w><kUp>", "<C-w><kUp>", { desc = "Go to upper window", remap = true })
map("n", "<C-w><kRight>", "<C-w><kRight>", { desc = "Go to right window", remap = true })
...
map("n", "<leader>wt", function() Util.terminal() end, { desc = "Terminal (cwd)" })
